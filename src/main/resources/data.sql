...
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (2, 'Will', 'Smith','willsmit@gmail.com','Developer', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (3, 'John', 'Son','jhonson@gmail.com','Networking', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (4, 'Peter', 'Son','peterson@gmail.com','Developer', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (5, 'John', 'Shalman','jhonshalaman@gmail.com','SolutionArchitect', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (6, 'Jamesh', 'raj','jameshraj@gmail.com','Developer', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (7, 'Arul', 'jamesh','aruljamesh@gmail.com','BusinessAnalyst', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (8, 'Rohit', 'Khan','rohitkhan@gmail.com','Developer', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (9, 'Mohamad', 'Samy','mohamadsamy@gmail.com','Developer', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (10, 'Angela', 'kiara','Angelakiara@gmail.com','Analyst', 1, 1);
insert into user (id, first_name, last_name, email,role, ticket_id, event_id) values (11, 'rosa', 'sawa','rosasawa@gmail.com','Developer', 1, 1);
